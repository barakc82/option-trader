...
RUN pip3 install ib_insync colorlog pytz exchange_calendars gspread psutil twilio dash aiohttp nest_asyncio Brotli yfinance "scikit-learn>=1.7" lightgbm xgboost pyyaml matplotlib pytest pyarrow --break-system-packages \
