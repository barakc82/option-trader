...
class TestOptionSafeguard(unittest.TestCase):
    ...
    def test_no_risk(self, trading_bot_class, market_data_fetcher_class, connect):
        ...
        trading_bot.close_short_option_position.assert_not_called()
    ...
    @patch('option_safeguard.MarketDataFetcher')
    @patch('option_safeguard.TradingBot')
    def test_handle_current_risk_outside_regular_trading_hours(self, trading_bot_class, market_data_fetcher_class, is_regular_hours, connect):
