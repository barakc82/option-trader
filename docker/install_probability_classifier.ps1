...
$localSource = "machine_learning\model\best_probability_model.pkl" # File on your Windows PC
$vmTempPath = "/tmp/best_probability_model.pkl"                     # Temporary staging path on the VM
$containerDir = "/home/option-trader/machine_learning/model"        # Directory inside the Docker container
$containerPath = "$containerDir/best_probability_model.pkl"         # Path inside the Docker container
